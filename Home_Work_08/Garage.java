...
public class Garage {
    ...
    public String getInfoParking() {
        return String.format("Вместимость парковки = %s, Количество свободных парковочных мест = %s, Количество занятых парковочных мест = %s", maxCapasity, freeParking, parkingSpace);
    }
}